  ...
  return (
    <footer className="flex flex-row items-center justify-center py-2 m-0 bg-white border-4 border-gray-500 rounded-2xl align-center center dark:bg-gray-900 dark:border-gray-400">
      ...
      <div className="inline-flex ml-6 space-x-4">
        <SocialIcon kind="mail" href={`mailto:${siteMetadata.email}`} size="12" />
        <SocialIcon kind="linkedin" href={siteMetadata.linkedin} size="12" />
        <SocialIcon kind="twitter" href={siteMetadata.twitter} size="12" />
        <SocialIcon kind="github" href={siteMetadata.github} size="12" />
      </div>
    </footer>
  )
}

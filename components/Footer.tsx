...
const Footer = (): JSX.Element => {
  return (
    <footer className="rounded-t-lg flex min-w-full items-center justify-around mt-5  bg-opacity-95 bg-gray-50 dark:bg-opacity-95 border-t-4 border-gray-400 dark:border-gray-50 dark:bg-gray-900 ">

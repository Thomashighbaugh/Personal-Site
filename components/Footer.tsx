...
const Footer = (): JSX.Element => {
  return (
    <footer className="py-1 flex min-w-full items-center justify-around mt-5  bg-opacity-75 bg-gray-50 dark:bg-opacity-30 border-t-2 border-gray-500 dark:border-gray-50 dark:bg-gray-900 ">

...
const Footer = (): JSX.Element => {
  return (
    <footer className="py-1 rounded-t-lg flex min-w-full items-center justify-around mt-5  bg-opacity-95 bg-gray-50 dark:bg-opacity-95 border-t-2 border-gray-500 dark:border-gray-50 dark:bg-gray-900 ">

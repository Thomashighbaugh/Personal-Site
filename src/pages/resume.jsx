                    ...
                    <div className="item">
                      ...
                      <div className="summary">
                        <p>
                          ...
                          leverages volunteer work and community donations to
                          help the needy
                        </p>
                      </div>
                      <ul className="highlights">
                        <li>
                          Assisted in rehabilitating old PCs for resident use in
                          job seeking
                        </li>
                        <li>
                          Stocking kitchen with fresh donations from local
                          grocery stores
                        </li>

      	...
      	<div className="posts">
		  	...
		  	<div className="post clearfix">
				...
				<div className="skill-item clearfix">
					...
					<ul className="">
						...
						<ul>
							<li><em>CSS3</em></li>
							<li><em>LESS</em></li>
							<li><em>SCSS // SASS</em></li>
							<li><em>SCSS Animations</em></li>
						</ul>
						</li>
						<li><em>Javascript</em>
							<ul>
						...
						<li><em>React*</em>
							<ul>
								<li><em>MaterialUI</em></li>
								<li><em>ReactStrap</em></li>
								<li><em>ReactBootstrap</em></li>
								<li><em>GatsbyJS</em></li>
								<li><em>Redux</em></li>
				...
				<div className="exclaimation">
					<em><b>*</b> React can also be rendered server side as well such as in the case of this site. This is known as Isomorphical Rendering. </em>
				</div>

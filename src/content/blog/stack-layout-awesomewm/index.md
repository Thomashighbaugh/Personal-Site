...
description: "Create a custom tabless mstab layout in AwesomeWM using Lua - a lightweight alternative to the bling library without unnecessary features."
summary: "Build your own custom stack layout for AwesomeWM that provides mstab functionality without tab bars or bloat, using clean Lua implementation."
date: "Sep 01 2021"
draft: false
tags:
- AwesomeWM
...
![AwesomeWM stack layout](./awesome-stack.png "Custom stack layout implementation in AwesomeWM")
...
There you have it! You've mastered a custom layout in AwesomeWM, taking control of your workspace without the extra fluff. 

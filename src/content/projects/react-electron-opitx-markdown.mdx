...
date: 07/13/19
summary: A Markdown editor with Live Preview beside the text editor itself wrapped up in an Electron.js application and packaged for major Linux platforms.
category: 'React'

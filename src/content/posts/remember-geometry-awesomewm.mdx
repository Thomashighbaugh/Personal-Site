---
title: Remember Geometry in AwesomeWM
date: '2021-09-01'
tags: [lua, awesomewm]
summary: When switching between Maximized and Regular floating in AwesomeWM, it is a pain to have to adjust your window after unmaximizing it, so why not store that size and return to it when the window is unmaximized?
---

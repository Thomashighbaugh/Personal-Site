  ...
  return (
    <style global jsx>
      {`
        ...
        code[class*="language-"],
        pre[class*="language-"] {
          @apply bg-white text-primary-300 dark:bg-primary-800 dark:text-primary-200;
        ...
        pre[class*="language-"] *::-moz-selection {
          @apply bg-black dark:bg-primary-300 dark:bg-opacity-25;
          color: inherit;
        }
        ...
        /* Code blocks */
        pre[class*="language-"] {
          @apply mb-1.5 overflow-auto p-4;
        }

        /* Inline code */
        :not(pre) > code[class*="language-"] {
          @apply whitespace-normal px-1.5 py-1;
        }

  ...
  function initBG() {
    const particlesSmall = generateParticles(2000);
    const particlesMedium = generateParticles(1000);
    const particlesLarge = generateParticles(500);
    ...
    const starsSmall = generateStars(2000);
    const starsMedium = generateStars(1000);
    const starsLarge = generateStars(500);

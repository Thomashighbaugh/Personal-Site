...
export const Blog = ({ projects }: BlogProps): JSX.Element => {
  return (
    <Layout>
      <div className=" bg-gray-50 bg-opacity-95 border-4 border-gray-400 dark:bg-gray-900 dark:bg-opacity-75 dark:border-gray-50 rounded-2xl p-6 my-20 mx-auto">
        <h1>Projects</h1>
      ...
      <div className="grid text-xl grid-cols-3 gap-8 ">
        {projects.map((project) => (
          <article
            key={project.slug}
            className="border-4 border-gray-400 dark:border-gray-50 p-4 bg-gray-50 dark:bg-gray-900 bg-opacity-95 dark:bg-opacity-75 rounded-2xl"
          >

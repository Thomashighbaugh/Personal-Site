...
export const Blog = ({ posts }: BlogProps): JSX.Element => {
  return (
    <Layout>
      <div className="max-w-6xl bg-gray-50 bg-opacity-95 border-4 border-gray-400 dark:bg-gray-900 dark:border-gray-50 dark:bg-opacity-95 rounded-2xl p-6 my-20 mx-auto text-lg">

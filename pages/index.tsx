...
export const Index = (): JSX.Element => {
  return (
    <Layout>
      <div className="min-w-6xl bg-gray-50 bg-opacity-75 border-4 text-center border-gray-400 dark:border-gray-50 dark:bg-gray-900 dark:bg-opacity-75 rounded-2xl p-4 my-20 mx-auto ">

...
export function getSortedPostsData() {
  ...
  const allPostsData = reactFilesData.concat(javascriptFilesData).concat(htmlFilesData)
...
export function getAllPostIds() {
  ...
  const fileNames = reactFileNames.concat(javascriptFileNames).concat(htmlFileNames)
